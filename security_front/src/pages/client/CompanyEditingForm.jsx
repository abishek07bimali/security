...
import { getSingleCompanyApi, updateCompanyApi } from "../../apis/api";

const CompanyEditingForm = () => {
  const { id } = useParams();
  ...
  const fetchCompanyDetails = async (companyId) => {
    try {
      const response = await getSingleCompanyApi(companyId);
      if (response.status === 200 && response.data.success) {
        ...
        // Set formatted dates and other details in state
        setCompanyBasicDetails({
          ...
          extendedDate: formatDate(company.extendedDate),
          companyImage: company.companyImage,
          contentData: company.contentData,
          website: company.website,
          registration: formatDate(company.registration),
        ...
        // Format timeline details including dates
        setCompanyTimelineDetails({
          timelines: company.timelines.map((timeline) => ({
            ...timeline,
        ...
        // Format funding details including dates
        setCompanyFundingDetails({
          fundings: company.fundings.map((funding) => ({
            ...funding,
            date: formatDate(funding.date),
            amount: funding.amount,
            description: funding.description,
          })),
        });

        setCompanyDetails({ basicDescription: company.basicDescription });
        setTargetMarketDetail({
          marketDescription: company.marketDescription,
          businesstype: company.businesstype,
          revenueStream: company.revenueStream,
        });
      } else {
  ...
  return (
    <div className="flex items-start justify-center min-h-screen bg-white">
      <div className="w-4/5 border-t p-4 bg-white rounded-lg">
          ...
          >
            ...
            <div className="mb-1">
              <label className="block mb-1">
                ...
                <input
                  ...
                  onChange={handleInputChange(setCompanyBasicDetails, "email")}
                  className="border border-gray-400 rounded-md px-3 py-2 mt-3 w-full"
                />
              </label>
            </div>
            <div className="mb-1">
              <label className="block mb-1">
                ...
                <input
                  ...
                  onChange={handleInputChange(setCompanyBasicDetails, "phone")}
                  className="border border-gray-400 rounded-md px-3 py-2 mt-3 w-full"
                />
              </label>
            </div>
            ...
            <div className="mb-1">
              ...
              {companyBasicDetails.companyImage && (
                <img
                  src={companyBasicDetails.companyImage}
                  alt="Company"
...
export default CompanyEditingForm;
